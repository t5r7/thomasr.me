...
async function nowFlickr() {
  ...
  // document.querySelector("#bg-cover").style.backgroundImage =
  // 	`url(${photoBGURL})`;
  ...
  const textSpan = document.createElement("span");
  textSpan.innerHTML = `I took <a href="${photoURL}">${photoTitle}</a> ${photoTakenAgo} ago in ${photoLocation}. I shared it ${photoUploadedAgo} ago, why not take a look?`;
  ...
  //   document.querySelector("#bg-cover").classList.add("loaded");
  //   document
